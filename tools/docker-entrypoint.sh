...
# This file is the results of this commit in the upstream repository:
# https://github.com/jboss-dockerfiles/keycloak/commit/89c77d05e70d95826806ea658f73fb5270c32f4d
...
# Start Keycloak #
##################
echo "Starting keycloak with args = '${SYS_PROPS} ${@}'"
